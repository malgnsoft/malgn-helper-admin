<!--
  ...
  섹션: 라벨 · 질문(AdminRichEditor) · 답변(AdminRichEditor) · 분류(scope/서비스/토픽/태그) ·
        중복 경고(생성 응답 similar[]) · 승인 워크플로(전이 버튼 + 반려 사유).
...
import { ArrowLeft, Trash2, Save, AlertTriangle, CheckCircle2 } from 'lucide-vue-next'
